  ...
  grandparent.parentNode
    ...
    ( function () {
      ...
      Quiz.prototype.check = function () {
        ...
        if (this.masteryScore/this._questions.length == 1){
          passed = true;
        }
        console.log(this.masteryScore/this._questions.length );
        console.log(passed);
    ...
    (function() {
      'use strict';
        ...
        function clickCompleteHandler(event) {
          if (passed){
          this.dispatchEvent(new CustomEvent('scormCompleted', {
            bubbles: true
          }));
        }
        else{
          document.getElementById("CompMsg").innerHTML = "You must pass the quiz in order to Complete the course!"
        }
        }
    
      
        document.getElementById('lesson-complete').addEventListener('click', clickCompleteHandler);
